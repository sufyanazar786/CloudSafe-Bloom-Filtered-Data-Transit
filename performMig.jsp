...
<h2><strong><%=length %> <%=re %> <%=rm %> ,<%=r %></strong></h2>
<strong>
<%
...
<h2><strong>The Upload limit is reached</strong></h2>
<strong>
<%
           }
...
<h2><strong>Transfered Successfully <%=mcloud %> and deleted ur existing vm in <%=cloud %></strong></h2>
<strong>
<%
...
<h2><strong>U Doesn't Have any Files in <%=cloud %> cloud</strong></h2>
			   <strong>
			   <%
		   }
		}catch(Exception e){
		...
		%>
		    ...
		    <h2><strong>Ur Not Registered to this <%=mcloud %> cloud</strong></h2>
               <strong>
               <%
	}
