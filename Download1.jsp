      ...
      <br/>
       ...
       <%
            ...
            <table width="478" border="0" align="center">
              <tr>
                <td width="223" bgcolor="#FF0000"><span class="style1">Enter File Name :-</span></td>
                <td width="245"><label>
                  <input required name="t1" type="text" value="<%=file%>" size="40" />
                </label></td>
              </tr>
			   <tr>
            <td width="223" bgcolor="#FF0000"><span class="style1">Owner Name:-</span></td>
             <td>   <select id="s1" name="oname" style="width:150px;" class="text">
			    ...
			    <tr>
            <td width="223" bgcolor="#FF0000"><span class="style1">User Name:-</span></td>
             <td>   <input name="un" type="text"  size="40" value="<%=un %>">
              ...
              <tr>
                <td height="34" bgcolor="#FF0000"><span class="style1">MAC :-</span></td>
                <td><input name="t12" type="text"  size="40" value="<%=mac %>"/></td>
              </tr>
              <tr>
                <td bgcolor="#FF0000"><span class="style1">Secret Key :-</span></td>
