...
<div class="logo">
<h1><a href="index.html">Secure Data Transfer </span> <small>and Deletion from Counting Bloom Filter in Cloud Computing</small></a></h1>
</div>
<div class="clr"></div>
<div class="menu_nav">
<ul>
...
<table width="598" border="0" align="center">
	...
	<p>&nbsp;</p>
	<tr>
		<td class="style4">Enter File Name or Keyword(<span class="style5">Use Any keyword from file desc</span>)</td>
